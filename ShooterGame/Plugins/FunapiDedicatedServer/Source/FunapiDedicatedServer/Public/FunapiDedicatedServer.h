...
namespace fun {
  namespace FunapiDedicatedServer {
    ...
    extern FUNAPIDEDICATEDSERVER_API bool ParseConsoleCommand(const TCHAR* cmd, const FString &match_id_field, const FString &manager_server_field, const FString &heartbeat_field, const FString &version_field);
